...
// QueryAccount queries the account edge of the User.
func (u *User) QueryAccount() *UserAccountQuery {
	return (&UserClient{u.config}).QueryAccount(u)
}
...
func (u *User) String() string {
	...
	buf.WriteString(fmt.Sprintf(", lastLogin=%v", u.LastLogin))
	buf.WriteString(")")
	return buf.String()
}
